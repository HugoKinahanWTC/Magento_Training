...
class FilmRepository implements FilmRepositoryInterface
{
    ...
    public function save(\Wtc\Film\Api\Wtc\Film\Api\Data\FilmInterface $film): FilmInterface
    {
    ...
    private function buildSearchResult(SearchCriteriaInterface $searchCriteria, Collection $collection): object
    {
